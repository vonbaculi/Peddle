      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">ADDS dapat</h1>
          </div>
        </div>
      </div>
    </div>
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Application Successfully Sent.</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Your Application request will be sent to the admin please patiently wait for their approval. </p>
							<p></p>
							<p><a href="<?php echo site_url('Home') ?>" class="btn btn-primary">Go Back</a></p>
						</div>
					</div>
				</div>
			</div>
