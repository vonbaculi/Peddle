  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Pending user Lists <?php echo $this->session->userdata('account_id');?></h3>
            </div>
			<!-- /.card-header -->
      ...
      <div class="card-body">
          ...
          <td><a href="<?php echo site_url('Sms/itexmo') ?>" class="btn btn-info" data-toggle="modal" data-target="#message<?php echo $count; ?>"><?php echo $row->status;?></a>
          </td>
          <div class="modal" id="message<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form method='POST' action="<?php echo site_url('EmailController/pending_acc') ?>">
                          <div class="form-group">
                              <input type="hidden" class="form-control" name ="email"value = "<?php echo $row->email ?>">
                          </div>
                          <div class="form-group">
                              <input type="hidden" class="form-control" name ="name"value = "	<td><?php echo $row->firstname;?></td>">
                          </div>
           ...
           <div class="modal" id="status<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
					...
					<td><a href="<?php echo site_url('admin/dashboard/deleteuser'); ?>/<?php echo $row->account_id?>" onclick='return window.confirm("Are you sure you want to delete this account");' class="btn btn-danger fas fa-trash-alt"></a>
           <a href="<?php echo site_url('admin/dashboard/update') ?>" class="btn btn-primary fas fa-edit" data-toggle="modal" data-target="#updatemodal<?php echo $count; ?>"></a>   </td>
           <div class="modal" id="updatemodal<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                      <form method='POST' action="<?php echo site_url('admin/dashboard/update'); ?>">
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="password" class="form-control"  name ="password" placeholder="Password" value = "<?php echo $row->firstname ?>">
                          </div>  
                          <div class="form-group">
                              <label for="exampleInputFirstName1">First Name</label>
                              <input type="text" class="form-control" name ="firstname" placeholder="First Name" value = "<?php echo $row->password ?>">
                          </div>
                          <div class="form-group">
