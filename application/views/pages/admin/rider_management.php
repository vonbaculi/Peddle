  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card-body">
			...
			<button type="button" style="float: right;" class="btn btn-primary" data-toggle="modal" data-target="#addridermodal" >Add Rider</button>
          ...
          <div class="modal" id="message<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                      <form method='POST' action="<?php echo site_url('EmailController/send_rider') ?>">
                          <div class="form-group">
					...
					<td>
          <a href="<?php echo site_url('admin/dashboard/rider_payments'); ?>/<?php echo $row->account_id?>" class="btn btn-warning fas fa-folder-open"></a>

          <a href="<?php echo site_url('admin/dashboard/delete_rider'); ?>/<?php echo $row->account_id?>" onclick='return window.confirm("Are you sure you want to delete this account  ");' class="btn btn-danger fas fa-trash-alt"></a>

           <a href="<?php echo site_url('admin/dashboard/update_rider') ?>" class="btn btn-primary fas fa-edit" data-toggle="modal" data-target="#updatemodal<?php echo $count; ?>"> </a></td>
           <div class="modal" id="updatemodal<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                      <form method='POST' action="<?php echo site_url('admin/dashboard/update_rider'); ?>" enctype="multipart/form-data">
                          <div class="form-group">
                              <input type="hidden" class="form-control" name ="account_id"value = "<?php echo $row->account_id ?>">
                          </div>
                          <div class="form-group">
                              <input type="hidden" class="form-control" name ="role" value="rider">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name ="username" placeholder="Username" value = "<?php echo $row->password ?>">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input  type="tel" pattern="^(09|\+639)\d{9}$"  class="form-control" name="contact_number" value = "<?php echo $row->contact_number ?>" placeholder="Number" >
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="file" name="userfile" value="userfile"class="form-control" accept="image/x-png,image/gif,image/jpeg"  placeholder="">
                          </div>
                          <div class="form-group">
                            <label for="exampleFormControlSelect1">Status</label>
   ...
   <div class="modal fade" id="addridermodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
        <form method='POST' action='<?php echo site_url('admin/dashboard/add_rider') ?>'  enctype="multipart/form-data">
               
                <div class="form-group">
                    <input type="hidden" class="form-control" name ="role" value = "rider" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">Account Image</label>
                    <input type="file" name="userfile" value="userfile"class="form-control" accept="image/x-png,image/gif,image/jpeg"  accept="image/x-png,image/gif,image/jpeg" placeholder="" required>
                </div>
                <div class="form-group">
