  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <td><?php echo $row->product_type;?></td>
					...
					<td> <a href="<?php echo site_url('admin/dashboard/delete_category'); ?>/<?php echo $row->category_id;?>" onclick='return window.confirm("Are you sure you want to delete this account  ");' class="btn btn-danger fas fa-trash-alt"></a>
          <a href="#" type="button" class="btn btn-primary fas fa-edit" data-toggle="modal" data-target="#updatemodal" <?php echo $row->category_id ;?>></a>
        </td>
					</tr><?php }?> 
                </tbody>
                <tfoot>
   ...
   <div class="modal fade" id="addusersmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method='POST' action='<?php echo site_url('admin/dashboard/add_category') ?>'>

                <div class="form-group">
                    <label for="exampleInputPassword1">New Category</label>
                    <input type="text" class="form-control" name ="prodduct_type" placeholder="New Category" value = "" required>
                </div>
            </div>
