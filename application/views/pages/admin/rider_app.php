    ...
    <section class="content">
      ...
      <div class="card-body">
          ...
          <td><?php echo $row->license;?></td>
					...
					<td><a href="<?php echo site_url('admin/dashboard/delete_application'); ?>/<?php echo $row->app_id?>" onclick='return window.confirm("Are you sure you want to delete this account  ");' class="btn btn-danger fas fa-trash-alt"></a></td>
