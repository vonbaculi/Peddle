  ...
  <div class="content-wrapper">
   ...
   <div class="modal fade" id="addusersmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method='POST' action='<?php echo site_url('admin/dashboard/add_product') ?>' enctype="multipart/form-data">
                <div class="form-group">
                    <label for="exampleInputPassword1">Product Name</label>
                    <input type="text" class="form-control" name ="product_name" required placeholder="Product Name"required>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Price</label>
                    <input type="text" class="form-control" name ="product_price" required placeholder="Price"required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="userfile" value="userfile"class="form-control" accept="image/x-png,image/gif,image/jpeg"  required placeholder="Product Image">
                </div>
                </div>
