  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card-body">
			...
			<button type="button" style="float: right;" class="btn btn-primary" data-toggle="modal" data-target="#addusersmodal" >Add Market</button>
          ...
          <?php foreach($market_data as $row) {?>
				<tr>
					<td><?php echo $row->market_id;?></td>
					<td><?php echo $row->market_name;?> Market</td>
			...
			<td><a href="<?php echo site_url('admin/dashboard/view_acc'); ?>/<?php echo $row->market_id?>" class="btn btn-warning far fa-folder-open"></a>
            <a href="<?php echo site_url('admin/dashboard/delete_market'); ?>/<?php echo $row->market_id?>" onclick='return window.confirm("Are you sure you want to delete this account  ");' class="btn btn-danger fas fa-trash-alt"></a>
           <a href="<?php echo site_url('admin/dashboard/market_update') ?>" class="btn btn-primary fas fa-edit" data-toggle="modal" data-target="#updatemodal<?php echo $count; ?>"></a></td>
           <div class="modal" id="updatemodal<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Update <?php echo $row->market_name ?> Market</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body">
                      <form method='POST' action="<?php echo site_url('admin/dashboard/market_update'); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                             <input type="hidden" class="form-control" name ="market_id" value = "<?php echo $row->market_id ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Market Name</label>
                            <input type="text" class="form-control" name ="market_name" placeholder="Market Name" value = "<?php echo $row->market_name ?>" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name ="Barangay" placeholder="Barangay" value = "<?php echo $row->Barangay ?>" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input  type="tel" pattern="^(09|\+639)\d{9}$"  class="form-control" name="contact_number" placeholder="Number" value = "<?php echo $row->contact_number ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Market Image</label>
                            <input type="file" name="userfile" value="userfile" class="form-control" placeholder="We need to validate of your are a legitimate customer" value = "<?php echo $row->market_img ?> " accept="image/x-png,image/gif,image/jpeg" required>
                        </div>
   ...
   <div class="modal fade" id="addusersmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
        <form method='POST' action='<?php echo site_url('admin/dashboard/add_market') ?>'  enctype="multipart/form-data">
              
                <div class="form-group">
                    <label for="exampleInputPassword1">Market Name</label>
                    <input type="text" class="form-control" name ="market_name" placeholder="Market Name" value = "" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">City</label>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Barangay</label>
                    <input type="text" class="form-control" name ="Barangay" placeholder="Barangay" value = "" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Street</label>
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">Number</label>
                    <input  type="tel" pattern="^(09|\+639)\d{9}$"  class="form-control" name="contact_number" placeholder="Number" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Description</label>
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">Market Image</label>
                    <input type="file" name="userfile" value="userfile" class="form-control" placeholder="We need to validate of your are a legitimate customer" accept="image/x-png,image/gif,image/jpeg"  required>
                </div>
