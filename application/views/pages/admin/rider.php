  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
			...
			<button type="button" style="float: right;" class="btn btn-primary fas fa-edit" data-toggle="modal" data-target="#addusersmodal" >ADD PRODUCT</button>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<tr>
					...
					<td> <a href="<?php echo site_url('admin/dashboard/deleteuser'); ?>/<?php echo $row->order_id;?>" onclick='return window.confirm("Are you sure you want to delete this account  ");' class="btn btn-danger">Delete</a>
          <a  type="button" class="btn btn-primary fas fa-edit" data-toggle="modal" data-target="#updatemodal" <?php echo $row->order_id ;?>>UPDATE</a></td>
   ...
   <div class="modal fade" id="addusersmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method='POST' action='<?php echo site_url('admin/dashboard/add_product') ?>'>
                ...
                <label for="exampleFormControlSelect1">Category</label>
                    <select class="form-control" name ="product_type" placeholder="Category" id="exampleFormControlSelect1">
