      ...
      <div class="card-body">
        ...
        <td><?php echo $row->account_id;?></td>
          ...
          <td><a href="<?php echo site_url('admin/dashboard/view_acc'); ?>/<?php echo $row->account_id?>" class="btn btn-warning far fa-folder-open"></a>
            <a href="<?php echo site_url('admin/dashboard/deleteuser'); ?>/<?php echo $row->account_id?>" onclick='return window.confirm("Are you sure you want to delete this account  ");' class="btn btn-danger fas fa-trash-alt"></a>
