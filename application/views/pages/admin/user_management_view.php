  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card-body">
			...
			<button type="button" style="float: right;" class="btn btn-primary" data-toggle="modal" data-target="#addusersmodal" >Add Account</button>
           ...
           <div class="modal" id="updatemodal<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form method='POST' action="<?php echo site_url('admin/dashboard/update'); ?>" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="file" name="userfile" value="userfile"class="form-control" accept="image/x-png,image/gif,image/jpeg"  placeholder="We need to validate of your are a legitimate customer">
                           </div>
                          <div class="form-group">
                            <label for="exampleFormControlSelect1">Role</label>
                                <select class="form-control" name ="role" placeholder="Role" id="exampleFormControlSelect1"<?php echo $row->role ?>>
                                  <option>user</option>
                                  <option>admin</option>
                                </select>
          ...
          <td><a href="<?php echo site_url('admin/dashboard/status') ?>" class="btn btn-success" data-toggle="modal" data-target="#status<?php echo $count; ?>"><?php echo $row->status ?> </a> 
          </td>
          <td><a href="<?php echo site_url('Sms/itexmo') ?>" class="btn btn-info" data-toggle="modal" data-target="#message<?php echo $count; ?>">Message</a>
          </td>
          <td><a href="<?php echo site_url('admin/dashboard/view_acc'); ?>/<?php echo $row->account_id?>" class="btn btn-warning far fa-folder-open"></a>
            <a href="<?php echo site_url('admin/dashboard/delete_user'); ?>/<?php echo $row->account_id?>" onclick='return window.confirm("Are you sure you want to delete this account  ");' class="btn btn-danger far fa-trash-alt"></a>
           <a href="<?php echo site_url('admin/dashboard/update') ?>" class="btn btn-primary fas fa-edit" data-toggle="modal" data-target="#updatemodal<?php echo $count; ?>"> </a>  
          ...
          <div class="modal" id="message<?php echo $count; ?>">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                      <form method='POST' action="<?php echo site_url('EmailController/send_user') ?>">
                          <div class="form-group">
