...
<html lang="en">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Apply As Rider</p>

      <form action="rider_request" method="post" enctype="multipart/form-data">
      <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
          <input  type="tel" pattern="^(09|\+639)\d{9}$"  class="form-control" name="number" placeholder="Phone Number" required>
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="form-group">
        <label for="exampleFormControlSelect1">Vehicle you use</label>
            <select class="form-control" name ="vehicle" placeholder="status" id="exampleFormControlSelect1" required>
                <option>Bike</option>
                <option>Motor</option>
            </select>
        </div>
        <div class="form-group">
        <label for="exampleFormControlSelect1">Nearest Market from you</label>
            <select class="form-control" name ="near_market" placeholder="status" id="exampleFormControlSelect1" required>
                <option>Quiapo</option>
                <option>Pritil</option>
            </select>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Picture of Driver's License</label>
      ...
      <div class="container py-4">
        <div class="row d-flex justify-content-center py-5">
          ...
          <div class="col-md-6 d-flex align-items-center">
            <form action="rider_request" class="subscribe-form">
