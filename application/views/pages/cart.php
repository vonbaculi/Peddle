...
<?php
    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
              ...
              <h4><span class="mr-2">SHOPPING CART</span> 
              <span> 
              <a style="float: right;" href="<?php echo site_url('Shopping_cart/destroy_cart') ?>" class="btn btn-danger py-2 px-3 text-white">Empty Cart</span></a>
              <a href="<?php echo site_url('Page/Checkout') ?>" style="float: right;" class="btn btn-success py-2 px-3">Checkout</a></h4>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="<?php echo site_url('Page/blog_views') ?>" class="py-2 d-block">Blog</a></li>
