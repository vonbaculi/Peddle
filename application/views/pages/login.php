  ...
  <div class="row d-flex justify-content-center py-5">
    <div class="register-box">
      <div class="register-logo">
        <a href="#"><b>PEDDLE</b>Inc.</a>
      </div>
  
 <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Log in</p>
        <form action="<?php echo site_url('login/validatelogin') ;?>" method="post">
          <div class="input-group mb-3">
            <input class="form-control" type="text" name="username" placeholder="Username" required <?php echo set_value('username'); ?>>          
          ...
          <div class="input-group mb-3">
          <input class="form-control" type="password" name="password" placeholder="Password" required <?php echo set_value('password'); ?>>
            <div class="input-group-append">
              <div class="input-group-text">
        ...
        <div class="mt-1 ">
        <p style="background-color:#d11339;text-align:center;text-white" class="text-white">
        ...
        <div class="row justify-content-center mt-1 mb-2">
            <a href="<?php echo site_url('Home') ?>" class="mr-5 btn btn-danger">Cancel</a><button type="submit" class="btn btn-success">Sign In</button>
          </div>
          <!-- /.col -->
		  
            <div class="row justify-content-center ">Don’t have an account?<a href="#" data-toggle="modal" data-target="#addusersmodal" class="txt3">
								Sign up now</a></div>	
          </div>
          <!-- /.col -->
        </div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <form method='POST' action='<?php echo site_url('Login/sign_up') ?> 'enctype="multipart/form-data">
                <div class="form-group">
                    <label for="exampleInputPassword1">First Name</label>
                    <input type="text" class="form-control" name ="firstname" placeholder="Ex: Luke" value = "" required>
				</div>
				<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name ="lastname" placeholder="Ex: Mark" value = "" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Username</label>
                    <input type="text" class="form-control" name ="username" placeholder="Ex: LukeMark123" value = "" required>
                </div>
                <div class="form-group">
                    ...
                    <label for="exampleInputPassword1">Phone Number</label>
				      	<input type="tel" pattern="^(09|\+639)\d{9}$" class="form-control" name="contact_number" placeholder="Phone Number" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" class="form-control" name ="email" placeholder="Ex: Luke@gmail.com" value = "" required>
                </div>
				        <div class="form-group">
                    <label for="exampleInputPassword1">Credential Files</label>
