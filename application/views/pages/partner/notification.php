  ...
  <div class="content-wrapper">
      ...
      <div class="card-body">
          ...
          <?php foreach($notif as $row) {?>
				<tr>
					...
					<td><a href="<?php echo site_url('admin/dashboard/view_acc'); ?>/<?php echo $row->notifiable_id?>" class="btn btn-warning far fa-folder-open"></a></td>
   ...
   <div class="modal fade" id="message" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method='POST' action='<?php echo site_url('partner/dashboard/message') ?>'  enctype="multipart/form-data">      
