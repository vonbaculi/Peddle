          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $count = 0; ?>
                <?php foreach($rider_order as $row) {?>
				        <tr>
                  ...
                  <td><a href="<?php echo site_url('rider/dashboard/view_order'); ?>/<?php echo $row->account_id?>/<?php echo $row->date?>" class="btn btn-warning fas fa-shopping-cart"></a>

                    <a href="<?php echo site_url('rider/dashboard/accept') ?>" class="btn btn-success" data-toggle="modal" data-target="#status"><?php echo $row->status_val ?> </a>    </td>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form method='POST' action="<?php echo site_url('rider/dashboard/accept');?>/<?php echo $row->market_name ?>">
                          <div class="form-group">
                              <input type="hidden" class="form-control" name ="order_id"value = "<?php echo $row->order_id ?>">
                          </div>
                          <div class="form-group">
                              <input type="hidden" class="form-control" name ="market_name"value = "<?php echo $row->market_name ?>">
                          </div>
                          <div class="form-group">
                              <input type="hidden" class="form-control" name ="payment_status"value = "<?php echo $row->payment_status ?>">
                          </div>
                          <div class="form-group">
