    ...
    <section class="ftco-section">
    	<div class="container">
			...
			<?php foreach($market_data as $row) {?>
				...
				<div class="product">
    					<a href="<?php echo site_url('Market_con/Single_Market') ?>/<?php echo $row->market_id;?>/<?php echo $row->market_name;?>" class="img-prod"><img class="img-fluid" src="<?php echo base_url()?>assets/vegefoods/images/<?php echo $row->market_img;?>" alt="Colorlib Template">
    						<span class="status"></span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
                <h3><a href="#"><?php echo $row->market_name;?> Market</a></h3>
                <p><a class="price-sale"><?php echo $row->City;?></a></p>
              </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('.add_cart').click(function(){
            var market_id    = $(this).data("productid");
            var market_name  = $(this).data("productname");
            var market_price = $(this).data("productprice");
            var quantity      = $('#' + market_id).val();
            $.ajax({
                url : "<?php echo site_url('Shopping_cart/add_to_cart');?>",
                method : "POST",
                data : {market_id: market_id, market_name: market_name, market_price: market_price, quantity: quantity},
...
<script>
      ...
      setInterval(function () {
        $(document).Toasts('create', {
          position	: 'bottomLeft',
          class: 'bg-wbite', 
          title: '<a href="apply/apply_rider"> Need Extra Income? </a>',
          subtitle: '<a>Apply now</a> ',
          autohide: true,
          ...
          showMethod: "fadeIn",
          hideMethod: "fadeOut",
          body: ' <a href="Product_con/recipe">   <img src="https://previews.123rf.com/images/stanciuc/stanciuc1503/stanciuc150300628/37605139-recycled-paper-note-pinned-on-cork-board-need-cash-message-concept-image.jpg" width="250" height="230"> </a>            '
