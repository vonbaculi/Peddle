...
<html lang="en">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Apply As Market</p>

      <form action="market_request" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="lastn ame" placeholder="Last Name" required>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-user"></span>
            </div>
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="market" placeholder="Market Name" requiredd>
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="address" placeholder="Market address" requiredd>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fa fa-map-marker"></span>
            </div>
        ...
        <div class="file-button">
            <label for="exampleInputPassword1">Picture of Business Permit</label>
            <input type="file" name="userfile" value="userfile" class="form-control" placeholder="We need to validate of your are a legitimate customer" required>
        </div>
