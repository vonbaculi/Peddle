...
<html lang="en">
  ...
  <body class="goto-here">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown05">
              	<a class="dropdown-item" href="<?php echo site_url('apply/apply_recipe') ?>" >Market</a>
    ...
    <?php foreach($single_recipe as $row) {?>
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/product-1.jpg" class="image-popup"><img src="<?php echo base_url()?>assets/vegefoods/images/<?php echo $row->recipe_img;?>"  class="img-fluid mb-5 " alt="Colorlib Template"></a>
            ...
            <div class="card border ">
              <div class="card-header shadow-lg">
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3>Name: <?php echo $row->recipe_name;?></h3>
    				<div class="rating d-flex">
							<p class="text-left mr-4">
              <a type="button" href="" class="btn btn-success "> <?php echo $row->ratings;?> Likes <i class="fas fa-thumbs-up"></i> </a>
							</p>
            ...
            <ul>
               <li><p><?php echo $row;?></p></li>
            </ul>
            
    		
            <?php }?>
            <a input type="button" href="<?php echo site_url('Product_con/add_cart') ?>/<?php echo $single_recipe[0]->recipe_name;?>" class="btn btn-primary py-3 px-5">Add Ingredients to cart</a>
    ...
    <section class="ftco-section">
        ...
        <div class="row">   
          ...
          <div class="product">
                <a href="<?php echo site_url('Product_con/single_recipe') ?>/<?php echo $row->recipe_name;?>"  class="img-prod"><img class="img-fluid" src="<?php echo base_url()?>assets/vegefoods/images/<?php echo $row->recipe_img;?>" alt="Colorlib Template">
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">

                  <h3><a href="#"><?php echo $row->recipe_name;?> </a></h3>
                  <div class="d-flex">
                    <div class="pricing">
